    ...
    <script>
        $(function () {
            ...
            $.extend($.validator.messages, {
                required: "<span style='color:red'>这是必填字段</span>",  //提示信息
                minlength: $.validator.format("<span style='color:red'>请输入不小于 4 的数值</span>")
            });
...
<!--[if lt IE 10]>
<script src="yingx/login/assets/js/placeholder.js"></script>
<![endif]-->
