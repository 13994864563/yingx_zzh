...
public class AliyunUtil {
    ...
    //说明 有备注无需修改的位置请勿改动
     static SendSmsResponse queryPhone(String phoneNumbers,String signName,String templateCode,String templateParam )throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4G4eCDv8w9Xs4ZR61FQz";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "AhdmzcSqfSEmHzyJtpHjXAO0qh68Su";//你的accessKeySecret，参考本文档步骤2
        ...
        SendSmsRequest request = new SendSmsRequest();
            ...
            //"17635422117,15698688515,13935826473"
    ...
    public static String sendPhoneMsg(String phoneNumbers,String code){
        ...
        try {
            ...
            String signName="鹿鸣张App";
            String templateCode="SMS_205616151";
    ...
    public static void main(String[] args) {
        String phoneNumbers="13994864563";
        String message = null;
            ...
            message = sendPhoneMsg(phoneNumbers, securityCode);
